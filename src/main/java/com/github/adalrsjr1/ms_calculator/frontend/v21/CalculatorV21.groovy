package com.github.adalrsjr1.ms_calculator.frontend.v21
...
class CalculatorV21 {
	private static final String DESTINATION = "http://localhost:8880/calculator/v2.1/"

	private static final Logger logger = LoggerFactory.getLogger(CalculatorV21.class);
